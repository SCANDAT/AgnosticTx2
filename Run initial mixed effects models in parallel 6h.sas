...
run;
proc sort datA=agtxoutp.univariate&tw._plotdata nodupkey;
by adjusted label predictor predictorvalue;
run;
...
proc sort data=agtxoutp.univariate&tw._type3 out=crude_pvals nodupkey;
where effect =: 'pred' and probf ne .;
by adjusted probf;
